...
echo Testing Random samples limit
java itu.ejuuragr.MiniStats itu.ejuuragr.UCT.EnhancementTester 0 6 0.5 0.25 0 0 0 0 0 0 >> "Enhancement RSL 6.txt"
...
echo Testing Random samples limit
java itu.ejuuragr.MiniStats itu.ejuuragr.UCT.EnhancementTester 0 10 0.5 0.25 0 0 0 0 0 0 >> "Enhancement RSL 10.txt"
echo Completed test (7/10)

echo %DATE% %TIME%

echo Testing Random samples limit
java itu.ejuuragr.MiniStats itu.ejuuragr.UCT.EnhancementTester 0 12 0.5 0.25 0 0 0 0 0 0 >> "Enhancement RSL 12.txt"
