...
%---------------------------------------------------------
\subsection{Softmax Backup} %TODO Meanmax måske?
...
In standard Monte Carlo Tree search as described by Browne et al. \cite{mctssurvey} %TODO reference
...
%TODO Probably doesn't make sense w/o guidance in which action to expand first (e.g. roulette wheel selection)
